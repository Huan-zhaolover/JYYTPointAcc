...
//  YTWeibo
//
//  Created by shjyyt on 17/4/3.
//  Copyright © 2017年 shjysoft. All rights reserved.
//
...
public enum YT_AlignType {
    ...
    func layoutAttributes(isInner: Bool, isVertical: Bool) -> YT_LayoutAttributes {
        let attributes = YT_LayoutAttributes()
        ...
        switch self {
            ...
            // 仅内部参照需要
            case .Center:
                return YT_LayoutAttributes(horizontal: .centerX, referHorizontal: .centerX, vertical: .centerY, referVertical: .centerY)
        }
    }
}
...
extension UIView {
    /**
     ...
     :returns: 约束数组
     */
    public func YT_Fill(referView: UIView, insets: UIEdgeInsets = UIEdgeInsets.zero) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func YT_AlignInner(type: YT_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint]  {
        
        return YT_AlignLayout(referView: referView, attributes: type.layoutAttributes(isInner: true, isVertical: true), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
    public func YT_AlignVertical(type: YT_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
        
        return YT_AlignLayout(referView: referView, attributes: type.layoutAttributes(isInner: false, isVertical: true), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
    public func YT_AlignHorizontal(type: YT_AlignType, referView: UIView, size: CGSize?, offset: CGPoint = CGPoint.zero) -> [NSLayoutConstraint] {
        
        return YT_AlignLayout(referView: referView, attributes: type.layoutAttributes(isInner: false, isVertical: false), size: size, offset: offset)
    }
    ...
    :returns: 约束数组
    */
    public func YT_HorizontalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    public func YT_VerticalTile(views: [UIView], insets: UIEdgeInsets) -> [NSLayoutConstraint] {
    ...
    :returns: 对应的约束
    */
    public func YT_Constraint(constraintsList: [NSLayoutConstraint], attribute: NSLayoutAttribute) -> NSLayoutConstraint? {
    ...
    :returns: 约束数组
    */
    func YT_AlignLayout(referView: UIView, attributes: YT_LayoutAttributes, size: CGSize?, offset: CGPoint) -> [NSLayoutConstraint] {
        
        translatesAutoresizingMaskIntoConstraints = false
        
        var cons = [NSLayoutConstraint]()
        
        cons += YT_positionConstraints(referView: referView, attributes: attributes, offset: offset)
        
        if size != nil {
            cons += YT_sizeConstraints(size: size!)
        }
        superview?.addConstraints(cons)
    ...
    :returns: 约束数组
    */
    func YT_sizeConstraints(size: CGSize) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
     func YT_sizeConstraints(referView: UIView) -> [NSLayoutConstraint] {
    ...
    :returns: 约束数组
    */
    func YT_positionConstraints(referView: UIView, attributes: YT_LayoutAttributes, offset: CGPoint) -> [NSLayoutConstraint] {
...
///  布局属性
final class YT_LayoutAttributes {
